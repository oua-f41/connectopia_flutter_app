...
abstract class _$$_ApiErrorCopyWith<$Res>
  ...
  @override
  @useResult
  $Res call({dynamic error, StackTrace stackTrace, ApiErrorModel errorModel});
}
...
class _$_ApiError implements _ApiError {
  const _$_ApiError(this.error, this.stackTrace, this.errorModel);
  ...
  @override
  String toString() {
    return 'DefaultError.apiError(error: $error, stackTrace: $stackTrace, errorModel: $errorModel)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(error), stackTrace, errorModel);
  ...
  TResult when<TResult extends Object?>({
    ...
    return apiError(error, stackTrace, errorModel);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return apiError?.call(error, stackTrace, errorModel);
  }
...
abstract class _ApiError implements DefaultError {
  const factory _ApiError(final dynamic error, final StackTrace stackTrace,
      final ApiErrorModel errorModel) = _$_ApiError;
